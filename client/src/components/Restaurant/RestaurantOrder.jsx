...
const RestaurantOrder = () => {
  ...
  return (
    ...
    //             <p>Order status : {mapItem?.order_status}</p>
    //           ) : (
    //             <div>
    //               <button
    //                 className="bg-gray-500 p-1 rounded text-white mr-3"
    //                 onClick={() =>
    //                   handleOrderStauts("success", parseInt(OrderId))
    //                 }
    //               >
    //                 Accept
    //               </button>
    ...
    //                 onClick={() =>
    //                   handleOrderStauts("cancelled", parseInt(OrderId))
    //                 }
    //               >
    //                 Cancel
    //               </button>
    ...
    //     })}
    // </div>
      <RestaurantOrderTable groupedOrder={groupedOrder} />
  );
};
